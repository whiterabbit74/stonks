...
const testData: OHLCData[] = [
  ...
  { date: new Date('2014-03-31'), open: 1000, high: 1010, low: 990, close: 1005, volume: 1000 },
  { date: new Date('2014-04-01'), open: 1005, high: 1015, low: 995, close: 1010, volume: 1000 },
  { date: new Date('2014-04-02'), open: 1010, high: 1020, low: 1000, close: 1015, volume: 1000 },
  
  // После сплита 2014-04-02 (цены ~$500+) - IBS < 0.1 для входа (close близко к low)
  { date: new Date('2014-04-03'), open: 505, high: 510, low: 500, close: 501, volume: 2000 }, // IBS = (501-500)/(510-500) = 0.1
  { date: new Date('2014-04-04'), open: 501, high: 510, low: 500, close: 500.5, volume: 2000 }, // IBS = 0.05 < 0.1
  { date: new Date('2014-04-05'), open: 500.5, high: 520, low: 500, close: 515, volume: 2000 }, // IBS = 0.75 для выхода
  { date: new Date('2014-04-06'), open: 515, high: 525, low: 512, close: 520, volume: 2000 },
  
  // До сплита 2022-07-15 (цены ~$2000+)
  { date: new Date('2022-07-14'), open: 2000, high: 2010, low: 1990, close: 2005, volume: 1000 },
  { date: new Date('2022-07-15'), open: 2005, high: 2015, low: 1995, close: 2010, volume: 1000 },
  
  // После сплита 2022-07-15 (цены ~$100+) - IBS < 0.1 для входа (close близко к low)
  { date: new Date('2022-07-16'), open: 100.25, high: 100.75, low: 99.75, close: 100, volume: 20000 }, // IBS = 0.25
  { date: new Date('2022-07-17'), open: 100, high: 101, low: 99.5, close: 99.6, volume: 20000 }, // IBS = 0.067 < 0.1
  { date: new Date('2022-07-18'), open: 99.6, high: 101.5, low: 99.5, close: 101, volume: 20000 }, // IBS = 0.75 для выхода
  { date: new Date('2022-07-19'), open: 101, high: 102, low: 100.5, close: 101.5, volume: 20000 },
];
...
describe('CleanBacktestEngine with Splits', () => {
  ...
  it('should apply splits correctly to price data', () => {
    ...
    const tradesAfter2022Split = result.trades.filter(trade => 
      trade.entryDate >= new Date('2022-07-15')
    );
  ...
  it('should handle multiple splits correctly', () => {
    ...
    const multiSplitData: OHLCData[] = [
      ...
      { date: new Date('2014-04-03'), open: 505, high: 510, low: 500, close: 501, volume: 2000 }, // IBS = 0.1
      { date: new Date('2014-04-04'), open: 501, high: 510, low: 500, close: 500.5, volume: 2000 }, // IBS = 0.05 < 0.1
      { date: new Date('2014-04-05'), open: 500.5, high: 520, low: 500, close: 515, volume: 2000 }, // IBS = 0.75 для выхода
    ...
    const trades2014 = result.trades.filter(trade => 
      trade.entryDate.getFullYear() === 2014
    );
    const trades2022 = result.trades.filter(trade => 
      trade.entryDate.getFullYear() === 2022
    );
