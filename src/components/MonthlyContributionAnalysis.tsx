        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-blue-300 dark:border-blue-700 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
            />
          </div>
          <div>
            <label className="block text-xs font-medium text-blue-700 dark:text-blue-300 mb-1">
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          {results.equity.length > 0 ? (
            <div className="w-full h-[440px] sm:h-[560px] lg:h-[660px]">
              <EquityChart
