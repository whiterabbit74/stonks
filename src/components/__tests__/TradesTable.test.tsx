...
describe('TradesTable', () => {
  const mockTrades: Trade[] = [
    ...
    {
      id: 'trade-2',
      entryDate: new Date('2023-12-06'),
      exitDate: new Date('2023-12-10'),
      entryPrice: 105.75,
      exitPrice: 98.25,
      quantity: 100,
      pnl: -750,
  ...
  it('should format dates correctly', () => {
    ...
    expect(screen.getByText('30.11.2023')).toBeInTheDocument(); // Entry date
    expect(screen.getByText('04.12.2023')).toBeInTheDocument(); // Exit date
  });
